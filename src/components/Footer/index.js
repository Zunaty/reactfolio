    ...
    return (
        <div className="bg-gradient-to-r from-gray-800 via-pink-800 to-red-400 flex flex-col flex-wrap text-white font-mono">
            ...
            <div className="m-auto md:text-lg text-center my-3 md:flex space-x-4">
                ...
                <a href="https://docs.google.com/document/d/1HKink6_NjinFAKIUpzhYKVrWZ8Af0Y9yTi8AI_bGc1A/edit?usp=sharing" target="_blank" rel="noreferrer" className="hover:text-gray-800 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">Resume</a>
            </div>
