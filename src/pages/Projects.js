...
export default function Projects(score) {
              ...
              <div className=" opacity-0 hover:opacity-100 bg-gradient-to-r from-gray-800 via-pink-900 text-white rounded-lg h-full">
                ...
                <div className="flex justify-end text-white space-x-3 m-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-lg ring-2 ring-gray-700 ring-offset-2 ring-offset-red-400 bg-pink-800 hover:bg-gray-800 shadow-md p-2"
                  >
                    GitHub
                  </a>
